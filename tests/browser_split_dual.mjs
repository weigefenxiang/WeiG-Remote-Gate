...
try {
  ...
  await page.waitForFunction(() => document.querySelector('#egress-select')?.value === 'dual:WAN2|WAN');
  ...
  assert(state.egress === 'dual:WAN2|WAN', `dual Internet Exit did not follow Access WANs (${state.egress})`);
