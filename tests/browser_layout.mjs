...
async function assertAccessLayout(page, expectedLayout = 'adaptive') {
  ...
  } else if (expectedLayout === 'side-by-side') {
    assert(sameRow && v4.right <= v6.left + 1.5, 'Dual Access desktop fields are not side by side');
  } else if (!sameRow) {
...
try {
  ...
  for (const [width, height, layout] of [[390, 844, 'stacked'], [1366, 768, 'side-by-side']]) {
